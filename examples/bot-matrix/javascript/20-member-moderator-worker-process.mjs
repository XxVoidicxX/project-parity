...
export const profile = Object.freeze({"id":"javascript-20-member-moderator-worker-process","language":"javascript","family":"member-moderator","shape":"worker-process","integration":"auto","actionType":"MEMBER_KICK","targetType":"user"});
