...
export const profile = Object.freeze({"id":"javascript-18-member-moderator-prefix-command","language":"javascript","family":"member-moderator","shape":"prefix-command","integration":"auto","actionType":"MEMBER_KICK","targetType":"user"});
