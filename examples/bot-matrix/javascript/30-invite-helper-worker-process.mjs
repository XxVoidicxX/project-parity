...
export const profile = Object.freeze({"id":"javascript-30-invite-helper-worker-process","language":"javascript","family":"invite-helper","shape":"worker-process","integration":"auto","actionType":"INVITE_CREATE","targetType":"invite"});
