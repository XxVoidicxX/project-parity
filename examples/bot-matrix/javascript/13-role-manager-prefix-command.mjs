...
export const profile = Object.freeze({"id":"javascript-13-role-manager-prefix-command","language":"javascript","family":"role-manager","shape":"prefix-command","integration":"auto","actionType":"ROLE_UPDATE","targetType":"role"});
