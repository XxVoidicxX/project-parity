...
export const profile = Object.freeze({"id":"javascript-35-event-coordinator-worker-process","language":"javascript","family":"event-coordinator","shape":"worker-process","integration":"auto","actionType":"GUILD_SCHEDULED_EVENT_UPDATE","targetType":"scheduled-event"});
