...
export const profile = Object.freeze({"id":"javascript-06-channel-manager-minimal","language":"javascript","family":"channel-manager","shape":"minimal","integration":"auto","actionType":"CHANNEL_UPDATE","targetType":"channel"});
