...
export const profile = Object.freeze({"id":"javascript-45-thread-support-worker-process","language":"javascript","family":"thread-support","shape":"worker-process","integration":"auto","actionType":"THREAD_CREATE","targetType":"thread"});
