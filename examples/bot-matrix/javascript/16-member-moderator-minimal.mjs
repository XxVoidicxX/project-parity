...
export const profile = Object.freeze({"id":"javascript-16-member-moderator-minimal","language":"javascript","family":"member-moderator","shape":"minimal","integration":"auto","actionType":"MEMBER_KICK","targetType":"user"});
