...
export const profile = Object.freeze({"id":"javascript-01-message-responder-minimal","language":"javascript","family":"message-responder","shape":"minimal","integration":"track","actionType":"MESSAGE_CREATE","targetType":"message"});
