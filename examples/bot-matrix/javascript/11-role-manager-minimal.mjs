...
export const profile = Object.freeze({"id":"javascript-11-role-manager-minimal","language":"javascript","family":"role-manager","shape":"minimal","integration":"auto","actionType":"ROLE_UPDATE","targetType":"role"});
