...
export const profile = Object.freeze({"id":"javascript-15-role-manager-worker-process","language":"javascript","family":"role-manager","shape":"worker-process","integration":"auto","actionType":"ROLE_UPDATE","targetType":"role"});
