...
export const profile = Object.freeze({"id":"javascript-48-permission-manager-prefix-command","language":"javascript","family":"permission-manager","shape":"prefix-command","integration":"auto","actionType":"CHANNEL_OVERWRITE_UPDATE","targetType":"overwrite"});
