...
export const profile = Object.freeze({"id":"javascript-08-channel-manager-prefix-command","language":"javascript","family":"channel-manager","shape":"prefix-command","integration":"auto","actionType":"CHANNEL_UPDATE","targetType":"channel"});
