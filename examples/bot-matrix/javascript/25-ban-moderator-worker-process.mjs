...
export const profile = Object.freeze({"id":"javascript-25-ban-moderator-worker-process","language":"javascript","family":"ban-moderator","shape":"worker-process","integration":"auto","actionType":"MEMBER_BAN_ADD","targetType":"user"});
