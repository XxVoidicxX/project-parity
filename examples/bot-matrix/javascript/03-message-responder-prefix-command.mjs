...
export const profile = Object.freeze({"id":"javascript-03-message-responder-prefix-command","language":"javascript","family":"message-responder","shape":"prefix-command","integration":"track","actionType":"MESSAGE_CREATE","targetType":"message"});
