...
export const profile = Object.freeze({"id":"javascript-21-ban-moderator-minimal","language":"javascript","family":"ban-moderator","shape":"minimal","integration":"auto","actionType":"MEMBER_BAN_ADD","targetType":"user"});
