...
export const profile = Object.freeze({"id":"javascript-29-invite-helper-slash-command","language":"javascript","family":"invite-helper","shape":"slash-command","integration":"auto","actionType":"INVITE_CREATE","targetType":"invite"});
