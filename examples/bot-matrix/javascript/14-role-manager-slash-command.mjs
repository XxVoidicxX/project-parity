...
export const profile = Object.freeze({"id":"javascript-14-role-manager-slash-command","language":"javascript","family":"role-manager","shape":"slash-command","integration":"auto","actionType":"ROLE_UPDATE","targetType":"role"});
