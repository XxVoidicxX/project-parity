...
export const profile = Object.freeze({"id":"javascript-43-thread-support-prefix-command","language":"javascript","family":"thread-support","shape":"prefix-command","integration":"auto","actionType":"THREAD_CREATE","targetType":"thread"});
