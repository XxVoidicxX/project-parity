...
export const profile = Object.freeze({"id":"javascript-04-message-responder-slash-command","language":"javascript","family":"message-responder","shape":"slash-command","integration":"track","actionType":"MESSAGE_CREATE","targetType":"message"});
