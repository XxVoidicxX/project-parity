...
export const profile = Object.freeze({"id":"javascript-34-event-coordinator-slash-command","language":"javascript","family":"event-coordinator","shape":"slash-command","integration":"auto","actionType":"GUILD_SCHEDULED_EVENT_UPDATE","targetType":"scheduled-event"});
