...
export const profile = Object.freeze({"id":"javascript-10-channel-manager-worker-process","language":"javascript","family":"channel-manager","shape":"worker-process","integration":"auto","actionType":"CHANNEL_UPDATE","targetType":"channel"});
