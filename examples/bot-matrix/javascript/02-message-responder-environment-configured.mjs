...
export const profile = Object.freeze({"id":"javascript-02-message-responder-environment-configured","language":"javascript","family":"message-responder","shape":"environment-configured","integration":"track","actionType":"MESSAGE_CREATE","targetType":"message"});
