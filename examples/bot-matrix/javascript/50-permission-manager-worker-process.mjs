...
export const profile = Object.freeze({"id":"javascript-50-permission-manager-worker-process","language":"javascript","family":"permission-manager","shape":"worker-process","integration":"auto","actionType":"CHANNEL_OVERWRITE_UPDATE","targetType":"overwrite"});
