...
export const profile = Object.freeze({"id":"javascript-49-permission-manager-slash-command","language":"javascript","family":"permission-manager","shape":"slash-command","integration":"auto","actionType":"CHANNEL_OVERWRITE_UPDATE","targetType":"overwrite"});
