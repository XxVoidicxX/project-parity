...
export const profile = Object.freeze({"id":"javascript-19-member-moderator-slash-command","language":"javascript","family":"member-moderator","shape":"slash-command","integration":"auto","actionType":"MEMBER_KICK","targetType":"user"});
