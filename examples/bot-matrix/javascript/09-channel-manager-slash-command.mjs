...
export const profile = Object.freeze({"id":"javascript-09-channel-manager-slash-command","language":"javascript","family":"channel-manager","shape":"slash-command","integration":"auto","actionType":"CHANNEL_UPDATE","targetType":"channel"});
