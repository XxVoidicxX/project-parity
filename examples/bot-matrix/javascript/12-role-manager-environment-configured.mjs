...
export const profile = Object.freeze({"id":"javascript-12-role-manager-environment-configured","language":"javascript","family":"role-manager","shape":"environment-configured","integration":"auto","actionType":"ROLE_UPDATE","targetType":"role"});
