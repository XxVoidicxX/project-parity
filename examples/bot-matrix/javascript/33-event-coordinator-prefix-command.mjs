...
export const profile = Object.freeze({"id":"javascript-33-event-coordinator-prefix-command","language":"javascript","family":"event-coordinator","shape":"prefix-command","integration":"auto","actionType":"GUILD_SCHEDULED_EVENT_UPDATE","targetType":"scheduled-event"});
