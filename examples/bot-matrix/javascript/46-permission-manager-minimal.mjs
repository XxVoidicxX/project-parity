...
export const profile = Object.freeze({"id":"javascript-46-permission-manager-minimal","language":"javascript","family":"permission-manager","shape":"minimal","integration":"auto","actionType":"CHANNEL_OVERWRITE_UPDATE","targetType":"overwrite"});
