...
export const profile = Object.freeze({"id":"javascript-44-thread-support-slash-command","language":"javascript","family":"thread-support","shape":"slash-command","integration":"auto","actionType":"THREAD_CREATE","targetType":"thread"});
