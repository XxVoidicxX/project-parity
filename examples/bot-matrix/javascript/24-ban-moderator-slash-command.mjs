...
export const profile = Object.freeze({"id":"javascript-24-ban-moderator-slash-command","language":"javascript","family":"ban-moderator","shape":"slash-command","integration":"auto","actionType":"MEMBER_BAN_ADD","targetType":"user"});
